...
import CollectableNew from './components/Collectable2'
...
import { setupScene1, setupScene2, rendenerSceneInfo } from './utils/utilsScene'
...
export default class App extends Engine {
  ...
  initGeometry (refs) {
    ...
    this.collectable2 = new CollectableNew(refs, this.scene, this.manager, this.camera, this.width, this.height)
    ...
    this.scene.add(this.collectable.collectableGroup)
	  this.sceneInfo1 = setupScene1()
	  this.sceneInfo2 = setupScene2()
  }
  ...
  animate () {
    // helpers
	  rendenerSceneInfo(this.sceneInfo1)
	  rendenerSceneInfo(this.sceneInfo2)
